<div class="mt-5">
    <h2 class="font-semibold text-lg mb-5">Objetivos del taller</h2>
    @foreach ($workshop->goals as $item)
    ...
    <article class="overflow-hidden rounded-lg shadow">
        <div class="px-6 py-4 bg-gray-100">
            <form wire:submit.prevent="store">
                <input wire:model="name" type="text" class="rounded w-full" placeholder="Agregar una meta...">
